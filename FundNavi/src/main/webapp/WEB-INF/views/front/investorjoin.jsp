      ...
      <div class="agile-contact-grids">
        <div class="agile-contact-left">
          <div class="col-md-6 contact-form">
            <h2 class="white-w3ls">投資家会員 <span>登録</span></h2>

            <form action="investorjoin" method="post">
            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
              <div class="styled-input">
                <td>
                  <font size="3em" color="white">銀行 </font>
                  <select name="bank">
                    <option value="ABank">a銀行</option>
                    <option value="BBank">b銀行</option>
                    <option value="CBank">c銀行</option>
                    <option value="DBank">d銀行</option>
                    <option value="EBank">e銀行</option>
                    <option value="FBank">f銀行</option>
                    <option value="GBank">g銀行</option>
                  </select>
                </td>
              </div>
              <div class="styled-input">
