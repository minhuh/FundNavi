				...
				<form role="form" action="/otoform" method="post" enctype="multiplart/form-data">
					...
					<table class="table-bordered">
						...
						<tbody>
								...
								<tr>
									<th>タイトル</th>
									<td><input type="text" placeholder="タイトルを入力してください。 "
										name="title" class="form-control"></td>
								</tr>
								<tr>
									<th>내용</th>
									<td><textarea class="enquiry-form" cols="126"
											placeholder="内容を入力してください。 " name="content" class="form-control"></textarea>
									</td>
								</tr>
									...
									<tr>
										<td></td>
										<td>
										<input type="submit" id="submit2" value="登録">
										<input type="button" value="戻る" onclick="location.href='onetoone'"></td>
									</tr>
