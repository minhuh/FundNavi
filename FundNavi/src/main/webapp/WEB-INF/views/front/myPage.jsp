		...
		<div class="container">
			<div class="agile_ab_w3ls_info">
				<div class="col-md-8 ab_pic_w3ls">
					<h1 class="aboutLabel">
					<p>${member.nickname} 様</p>
					</h1>
					<c:if test="${member.account == null}">
						<p><a href="investorjoin">投資家会員登録</a></p>
					</c:if>
					<c:if test="${member.account != null}">
						<p>投資家会員です。</p>
					</c:if>
					<a href="mypageMyProject">
						<h3 class="mypageLinkProject">私のプロジェクト</h3>
					</a>
					<a href='profileEdit' class='mypageLinkEditBtn'>情報修正</a>
				</div>
				<div class="col-md-4 ab_pic_w3ls_text_info">
					...
					<c:if test="${member.profile_image != null}">
						<img src="resources/upload/${member.profile_image}">
					</c:if>
					</div>
				</div>
